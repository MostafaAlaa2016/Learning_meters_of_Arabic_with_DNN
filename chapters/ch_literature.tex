...
In this chapter, We will present the previous work in this area of research or study. Also, we will present any similar work related to our current research.
...
\item \textbf{The size of the test data} which cannot measure the accuracy for any algorithms they have constructed because it is a very small dataset. Also, a 75\% total accuracy of 128 verses is even worse.
  ...
  We can summarize the difference between our work results and the previous work in Table~\ref{Tab:Summary_Results}
