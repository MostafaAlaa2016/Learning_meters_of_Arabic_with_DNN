...
\cite{Alnagdawi2013FindingArabicPoemMeter} has taken a similar approach to the previous work, but it replaced the if-else} by regular expressions} templates. This approach formalized the scansion}s, Arud} based on lingual rules relating to pronounced and silent rules, directly related to harakat} as context-free grammar}. Only 75\% of128 verses were correctly classified. 
