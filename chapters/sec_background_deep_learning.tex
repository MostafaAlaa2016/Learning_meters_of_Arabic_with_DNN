...
One of the examples of the text problems in DL is classifying text based on character-level. Figure~\ref{Fig:Deep_Learning_Char_Level_Example} shows how deep learning can work to represent a sequence of a sentence by combining simpler representation, e.g. understand the character-sequence pattern which led to understanding complex representations.
