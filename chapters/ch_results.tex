...
%*  Enhance the classification results to be same as the human expert.• Use the current datasets to classify the poem meaning *as this paper did not work for this idea. • Analyze the historical impact based on the Poem and the Poetry for example for a specific period Is the Poem affected by this period, or there are patterns of writing between the Poetry or not. • Can we generate from each class some poem similar to the poetry poems?
