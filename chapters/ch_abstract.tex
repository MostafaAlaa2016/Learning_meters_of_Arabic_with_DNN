...
% Please make sure you use the encoding consistently as I did above across the whole thesis.

% ``...explain in details...'' => ``... in detail''

% ``..as regards the Arabic language'' => ``...on Arabic language ''
