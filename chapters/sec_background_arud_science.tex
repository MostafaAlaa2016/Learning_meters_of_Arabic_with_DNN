...
\begin{figure}[!t]
  \centering
  \subfigure[Meters Group.]{\label{Fig:AlMokhtalf}
\input{./Figures/Ch_2_Background/Fig_AlMokhtalf_Circle.tex}
}
  \subfigure[Tanh activation function.]{\label{Fig:AlMokhtalf2}
\input{./Figures/Ch_2_Background/Fig_AlMokhtalf_Circle.tex}
}          
\subfigure[Linear activation function.]{\label{Fig:AlMokhtalf3}
\input{./Figures/Ch_2_Background/Fig_AlMokhtalf_Circle.tex}
}
\subfigure[Logistic sigmoid activation function.]{\label{Fig:AlMokhtalf4}
  \input{./Figures/Ch_2_Background/Fig_AlMokhtalf_Circle.tex}
}
