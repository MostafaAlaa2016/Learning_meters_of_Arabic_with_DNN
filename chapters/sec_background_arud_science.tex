...
feet consists of three parts (Asbab (means Reasons in English) \textarabic{أسباب}, Awtaad (means Wedges in English) \textarabic{أوتاد}, Fawasel (means Breaks in English) \textarabic{فواصل}).
\begin{itemize}
...
%    \bottomrule                                              
%  \end{tabular}
%  \caption{Al-Mokhtalef Circle Group.}\label{Tab:AlMokhtalef}
%\end{table}
%
%\begin{table}[t]
%  \centering
