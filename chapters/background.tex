...
Al-Madeed is named because of the reasons \textarabic{الأسباب} is represented into all its seven parts of tafa'il, One in the first part and the other in the second part. So, it named Madeed \textarabic{مديداً}.
% @@@note to add references
...
Al-Baseet there is a different ideas behind this name 
\begin{itemize}
\item The Reasons \textarabic{الأسباب} is expanded \textarabic{انبسطت} into it's tafa'il. So, you will find in the begining of every  part two reasons so, it named Al-Baseet.
\item The other reasons which may be the more logic is the harkat \textarabic{الحركات} is expanded in its tafa'il.
\end{itemize}
...
Al-Wafer there are a different ideas behind this name 
\begin{itemize}
\item There are a lot of harakat into its parts because there is not part has harakat more than \textarabic{مفاعلتن}
\item There are a lot of parts into its base.
\end{itemize}
% @@@note to add references
...
\textit{Al-Kamel is named Al-Kamel because its harakat is fully integrated and it is 30 harakah which is not similar to any other Bahr this numbers of harakat. However, Al-wafer has a lot of harakat in it is source \textarabic{أصله} but not same number as AL-Kamel. Al-Wafer has the harakat but it not over written into it's source but Al-Kamel it is written into its source. So, AL-Kamel in Arabic named due to it is more integrated \textarabic{أكمل} than Al-wafer  }
...
\textit{Al-Hazaj is named Al-Hazaj because the sound reverberation in its parts. Al-Hazaj in Arabic is sound frequency. So, due to the sound reverberation it named AL-Hazaj. Also, Because every part end by two reasons so, it made some of sound as a music to be Al-Hazaj.  }
...
\textit{Al-Rejz is named Al-Raml because Al-Raml is a type of the singing which is constructed from this Bahr. Another reason is the Wedges is apear in between the Reasons so, it named Al-Raml due to the diversity between the Reasons and the wedges inside the tafa'il.}
% @@@note to add references
...
\textit{Al-Sarea is named Al-Sarea in Arabic Al-Sarea means the fastest. It named these because its speed in teste \textarabic{الزوق} or its parts\textarabic{التقطيع}. The other reason because its three parts has 7 reasons and the reasons is faster than the wedges.}
% @@@note to add references
...
\textit{Al-Khafeef name in Arabic means light. The reason behind the name is its wedge last harkah connected to its reason so, it became light \textarabic{خفت}. The other reason is its light in teste \textarabic{الزوق} or its parts\textarabic{التقطيع} because it has a part with three reasons and the reasons is more lighter than wedges. }
% @@@note to add references
...
\textit{Al-Modarea in Arabic means the present. It named by this name because it is the present of the Al-Hazaj. Also, This Bahr wasn't famous in Arabic Poem and there weren't any popular peams or poetry used this Bahr before. }
% @@@note to add references
...
\textit{Al-Moktadeb in Arabic means reproduce from another thing \textarabic{الإقتطاع} and because this Bahr words is all appeared into Al-Monsareh in all its words but also there are a difference in the order of the parts. So, it named Al-Moktadeb because it seems to be reproduced from Al-Monsareh. We will have another section which will focus on the relation between the bohor. (add the reference) % @@@note to add references of the section
}
% @@@note to add references
...
\textit{Al-Mojtaz in Arabic name is similar meaning for AL-Moktadeb it means reproduced from another thing \textarabic{الإقتطاع أو الإجتزاز} and because this Bahr words is all appeared into Al-khafeef in all its words but also there are a difference in the order of the parts. So, it named Al-Mojtaz because it seems to be reproduced from Al-khafeef \textarabic{إجتُزَّ من بحر الخفيف}}
...
\textit{Al-Motaqareb in Arabic means convergent and it named by this name because the wedges is convergent to each others this is because between every two wedges one reason so the wedges is convergent to each others. Also, another reason is its parts is simiar to each other so it named AL-Motaqareb. It has eight parts.
}
% @@@note to add references
...
\begin{itemize}
\item Al-Motadarek in Arabic means be explored because This Bahr is forgotten by Al-Farahidi and his student Al-Akhfash Al-Awsat %%@@@ (215/830)
  has explore it named by this name. 
\item Al-Motadarek in Arabic also means followed by something \textarabic{يُدرك} and because this Bahr came after Al-Motaqareb it name Al-Motadarek.
\end{itemize}
% @@@note to add references
% @@@@ سبب تسمية البحر المتدارك بهذا الاسم:
%سُمِّيَ المتدارَك بهذا الاسم؛ لأن الأخفش الأوسط تدارك به على الخليل الذي أهمله، ويُسَمَّى أيضا بالمتدارِك لأنه تدارك بحر المتقارب أي التحق به، وذلك لأنه خرج منه بتقديم السبب على الوتد. ومنهم من يسميه المحدث لحداثة عهده، أو المخترع لأن الأخفش اخترعه فهو لم يكن ضمن البحور التي استقرأها الخليل من الشعر العربي، ويسميه بعضهم المتَّسق؛ لأن كل أجزائه على خمسة أحرف، والشقيق لأنه أخو المتقارب إذ كل منهما مكون من سبب خفيف ووتد مجموع.
