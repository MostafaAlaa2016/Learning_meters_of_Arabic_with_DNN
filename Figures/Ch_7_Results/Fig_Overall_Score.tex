\begin{tikzpicture}[scale=1.7]
  ...
  \node [align=center, text width=3cm, inner sep=0.25cm] at (2.1, \yONE) {\large no trimming(0T)};
  \node [align=center, text width=4cm, inner sep=0.25cm] at (6.32,\yONE) {\large trimming(1T)};

  \node [align=center, text width=3cm, inner sep=0.25cm] at (1, \yTWO) {\large diacritic(1D)};
  \node [align=center, text width=3cm, inner sep=0.25cm] at (3, \yTWO) {\large no diacritic(0D)};
  \node [align=center, text width=3cm, inner sep=0.25cm] at (5+0.2, \yTWO) {\large diacritic(1D)};
  \node [align=center, text width=3cm, inner sep=0.25cm] at (7+0.2, \yTWO) {\large no diacritic(0D)};
  ...
  \node  at (3.5*   \step -0.15-\move, \layerHeight) {\large 7L};
  \node  at (3.5*   \step -0.15-\move, \unitHeight) {\large 82U};
  \node  at (3.5*   \step -0.1 -\move, \weightedHeihgt) {\large 0};

  \node  at (5.2*   \step, \layerHeight) {\large 7L};
  \node  at (5.2*   \step, \unitHeight) {\large 50U};
  \node  at (5.2*   \step, \weightedHeihgt) {\large 1};

  \node  at (7*     \step +0.15+\move, \layerHeight) {\large 7L};
  \node  at (7*   \step   +0.15+\move, \unitHeight) {\large 50U};
  \node  at (7*   \step   +0.1 +\move, \weightedHeihgt) {\large 1};

  %%%%%%

  \node  at (14*    \step -0.15-\move, \layerHeight) {\large 7L};
  \node  at (14*   \step -0.15 -\move, \unitHeight) {\large 82U};
  \node  at (14*   \step -0.1  -\move, \weightedHeihgt) {\large 0};

  \node  at (16*    \step, \layerHeight) {\large 7L};
  \node  at (16*    \step, \unitHeight) {\large 82U};
  \node  at (16*    \step, \weightedHeihgt) {\large 0};

  \node  at (17.6*  \step +0.15+\move, \layerHeight) {\large 7L};
  \node  at (17.6*  \step +0.15+\move, \unitHeight) {\large 50U};
  \node  at (17.6*  \step +0.1 +\move, \weightedHeihgt) {\large 0};

  %%%%%%

  \node  at (24.5*  \step -0.15-\move, \layerHeight) {\large 7L};
  \node  at (24.5*  \step -0.15-\move, \unitHeight) {\large 82U};
  \node  at (24.5*  \step -0.1 -\move,  \weightedHeihgt) {\large 1};

  \node  at (26.1*  \step, \layerHeight) {\large 7L};
  \node  at (26.1*  \step, \unitHeight) {\large 82U};
  \node  at (26.1*  \step, \weightedHeihgt) {\large 0};

  \node  at (28*    \step +0.15+\move, \layerHeight) {\large 7L};
  \node  at (28*    \step +0.15+\move, \unitHeight) {\large 82U};
  \node  at (28*    \step +0.1 +\move,  \weightedHeihgt) {\large 1};

  %%%%%%

  \node  at (35*    \step -0.15-\move, \layerHeight) {\large 4L};
  \node  at (35*    \step -0.15-\move, \unitHeight) {\large 82U};
  \node  at (35*    \step -0.1 -\move,  \weightedHeihgt) {\large 0};

  \node  at (37*    \step, \layerHeight) {\large 7L};
  \node  at (37*    \step, \unitHeight) {\large 82U};
  \node  at (37*    \step, \weightedHeihgt) {\large 0};

  \node  at (38.7*  \step +0.15+\move, \layerHeight) {\large 4L};
  \node  at (38.7*  \step +0.15+\move, \unitHeight) {\large 50U};
  \node  at (38.7*  \step +0.1 +\move,  \weightedHeihgt) {\large 1};
  ...
  \begin{axis}[
    ...
    nodes near coords style={font=\large,anchor=-90, text width=1cm},
    ]
...
(21, 0.9284854653773613) % Exp_12_T0_D0_twohot_LSTM_3_82_1
    ...
    %\legend{{\large{Binary(BinE)}}, {\large{One-Hot(OneE)}}, {\large{Two-Hot(TwoE)}}}
  ...
  \end{axis}
    ...
    \ref{BiLSTM} \large{BiLSTM}
    \ref{LSTM} \large{LSTM}}};

    % Encoding legend
    \node [draw,fill=white] at (4.2,-1.75) {\shortstack[l]{
    \ref{Binary} \large{\large{Binary(BinE)}}
    \ref{OneHot} \large{\large{One-Hot(OneE)}}
    \ref{TwoHot} \large{\large{Two-Hot(TwoE)}}
    }};
